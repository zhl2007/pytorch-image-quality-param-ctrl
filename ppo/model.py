...
class MLPPolicy(torch.nn.Module):
    def __init__(self, num_inputs, action_space):
        ...
        self.a_fc1 = nn.Linear(num_inputs, 512, bias=False)
        self.a_ab1 = AddBias(512)
        self.a_fc2 = nn.Linear(512, 64, bias=False)
        ...
        self.v_fc1 = nn.Linear(num_inputs, 512, bias=False)
        self.v_ab1 = AddBias(512)
        self.v_fc2 = nn.Linear(512, 64, bias=False)
